...
?>
    ...
    <?php
    $sql1 ="INSERT INTO `order_history` (`order_id`, `status`, `name`, `address`, `mobile`, `totalPrice`, `Pid of article`, `token_no`) VALUES (NULL, '', '', '', '', '', '', ''); "
    ?>
    ...
    <div class="col-md-6">
        ...
        <div class="card">
                <div class="card-body">
                   ...
                   <form action="save_database.php" method="post" class="form">
                   <div class="form-group">
                        ...
                        <div>
                            <button type="Sumbit" class="btn btn-primary" onclick="savedata()">Payment</button>
